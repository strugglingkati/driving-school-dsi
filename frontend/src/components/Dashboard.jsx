...
import { Users, Wallet, GraduationCap, Activity, ShieldCheck } from 'lucide-react';
...
const Dashboard = ({ stats }) => {
    ...
    const cards = [
        ...
        },
        {
            ...
            color: 'bg-info',
            description: 'المترشحون الذين حصلوا على الرخصة'
        }
    ];
                ...
                <div className="card border-0 shadow-sm rounded-4 overflow-hidden">
                    <div className="row g-0 align-items-center">
                        <div className="col-lg-8 p-4">
                            ...
                            <p className="text-muted mb-4">احصل على نظرة سريعة على حالة المترشحين، الدفعات، ونسبة النجاح في النظام.</p>
